#!/usr/bin/env python
"""
Simple integration script for Manus Bridge.

This script helps integrate the Manus Bridge with manus-manager.
"""
...
def create_manus_bridge_client(manus_manager_path):
...
def main():
    ...
    if not create_manus_bridge_client(args.manus_manager_path):
    ...
    # Update the .env file
    if not update_env_file(args.manus_manager_path):
        print("Failed to update .env file")
        sys.exit(1)
    
    print("\nIntegration complete!")
    print("\nTo start the Manus Bridge API server:")
    print("  cd /Users/feliperecalde/Desktop/Apps/hack-manus/manus-bridge")
